export const zodiacSigns = {
  ...
  capricorn: {
    ...
    symbol: "♑",
    emoji: "🐐",
    personality: "Ambitious, disciplined, and practical. You have a natural ability to climb mountains, both literal and metaphorical. Your persistence and determination are legendary.",
    strengths: ["Strong work ethic", "Leadership abilities", "Discipline", "Long-term planning", "Reliability"],
    weaknesses: ["Can be too serious", "Workaholic tendencies", "Difficulty expressing emotions", "May be overly traditional", "Can be pessimistic"],
    lifePath: "Your path involves achieving mastery and success while learning to balance ambition with compassion. You're meant to build lasting structures and institutions.",
    opportunities: "Business, government, architecture, management, finance, and any field requiring long-term planning and leadership.",
    challenges: "Learning to relax and enjoy life, expressing emotions more freely, and balancing work with personal relationships."
  },
  aquarius: {
    name: "Aquarius",
    ...
    symbol: "♒",
    emoji: "🏺",
    personality: "Independent, innovative, and humanitarian. You're a visionary who sees the future before others. Your unique perspective and desire to help humanity set you apart.",
    strengths: ["Independent thinking", "Humanitarian spirit", "Innovation", "Friendship abilities", "Visionary thinking"],
    weaknesses: ["Emotional detachment", "Can be rebellious", "Difficulty with intimacy", "May be unpredictable", "Can seem aloof"],
    lifePath: "Your journey involves bringing new ideas and innovations to benefit humanity. You're meant to be a revolutionary, creating positive change in the world.",
    opportunities: "Technology, science, social work, activism, research, and any field involving innovation or humanitarian efforts.",
    challenges: "Developing emotional intimacy, being more consistent in relationships, and balancing independence with cooperation."
  },
  pisces: {
    name: "Pisces",
    ...
    symbol: "♓",
    emoji: "🐟",
    personality: "Intuitive, compassionate, and artistic. You have a deep connection to the spiritual realm and unlimited imagination. Your empathy allows you to understand others' pain and joy.",
    strengths: ["Strong intuition", "Compassion", "Artistic abilities", "Spiritual insight", "Adaptability"],
    weaknesses: ["Tendency to escape reality", "Overly sensitive", "Difficulty with boundaries", "Can be indecisive", "May be taken advantage of"],
    lifePath: "Your path involves using your intuition and compassion to heal and inspire others. You're meant to be a bridge between the material and spiritual worlds.",
    opportunities: "Arts, healing, spirituality, counseling, music, and any field requiring empathy and intuition.",
    challenges: "Setting healthy boundaries, staying grounded in reality, and learning to say no when necessary."
  }
};
